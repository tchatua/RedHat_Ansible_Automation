...
sudo hostnamectl set-hostname ansible_client

#Enable Password-Less SSH communication
...
sudo echo '<h1>Welcome to Ansible City - APP-1</h1>' | sudo tee /var/www/html/index.html
