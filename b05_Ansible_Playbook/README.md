...
- name: Directory Creation
  ...
  become: yes
  tasks:
    - name: Create a directory /opt/scripts if it does not exist
...
```sh
[ec2-user@ansiblecontroller a01_Ansible_Lab]$ ansible-playbook --syntax-check a03_Create_Directory.yml
playbook: a03_Create_Directory.yml

run /home/ec2-user/a01_Ansible_Lab/a03_Create_Directory.yml -i /home/ec2-user/a01_Ansible_Lab/a01_Inventory.ini
